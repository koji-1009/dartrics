...
- `lib/dartrics.dart` exposes the function-level metric calculator classes alongside the existing report shapes for embedders. New exports: `AnalyzedFile`, `ExplainEntry`, `dartricsVersion`.
